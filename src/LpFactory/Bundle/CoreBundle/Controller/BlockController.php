...
class BlockController extends Controller
{
    ...
    public function defaultAction(AbstractBlock $block, $edit = false)
    {
        ...
        return $response->setContent(
            $this->get('lp_factory.block.renderer')->renderView($block, $edit)
        );
    }
    ...
    public function editFormAction(Request $request, $id)
    {
        ...
        $configuration = $this->get('lp_factory.block.configuration.chain')->getConfiguration($block->getAlias());
        ...
        if ($form->isValid()) {
            $this->get('lp_factory.block.manager')->save($block);
    ...
    public function removeAction($id)
    {
        ...
        $this->get('lp_factory.block.manager')->remove($block);
    ...
    protected function loadBlock($id)
    {
        ...
        $block = $this->get('lp_factory.repository.block')->findWithPage((int) $id);
        if (!$block) {
