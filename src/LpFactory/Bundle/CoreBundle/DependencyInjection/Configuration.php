        ...
        $node
            ...
            ->prototype('array')
                ->children()
                    ...
                    ->scalarNode('label')->defaultValue('tools.default_label')->end()
                    ->scalarNode('picto')->defaultValue('glyphicon glyphicon-file')->end()
                    ->scalarNode('text')->defaultValue('tools.default_text')->end()
                ->end()
            ->end()
        ;
            ...
            ->prototype('array')
                ->children()
                    ->scalarNode('view_template')
                        ->defaultValue('LpFactoryCoreBundle:Block:View/default_view.html.twig')
                    ->end()
                    ...
                    ->scalarNode('edit_template')
                        ->defaultValue('LpFactoryCoreBundle:Block:View/default_edit.html.twig')
                    ->end()
