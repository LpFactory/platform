...
namespace LpFactory\Bundle\CoreBundle\Tests\Routing\Provider;
...
use LpFactory\Bundle\CoreBundle\Routing\Provider\PageRouteProvider;
 ...
 *
 * @package LpFactory\Bundle\CoreBundle\Tests\Routing\Provider
 * @author jobou
 */
class PageRouteProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetRouteCollectionForRequest()
    {
        ...
        $routeConfigurationChain = $this
            ->getMock(
                'LpFactory\Bundle\CoreBundle\Routing\Configuration\PageRouteConfigurationChainInterface'
            );
    ...
    public function testGetRouteByName()
    {
        ...
        $routeFactory = $this
            ->getMock('LpFactory\Bundle\CoreBundle\Routing\Factory\PageRouteFactoryInterface');
        $routeFactory
            ->expects($this->once())
            ->method('createFromId')
    ...
    public function createPageRouteProvider(
        ...
        if ($urlSatinizerChain === null) {
            ...
            $urlSatinizerChain = $this
                ->getMock('LpFactory\Bundle\CoreBundle\Routing\Satinizer\UrlSatinizerChainInterface');
            $urlSatinizerChain
                ->expects($this->any())
                ->method('clean')
        ...
        if ($treeStrategy === null) {
            $page = $this->getMock('LpFactory\Bundle\CoreBundle\Model\AbstractPage');
            $page
                ->expects($this->any())
                ->method('getId')
                ->willReturn(56);
            ...
            $treeStrategy = $this
                ->getMockBuilder('LpFactory\Bundle\CoreBundle\Routing\Strategy\AbstractTreeStrategy')
