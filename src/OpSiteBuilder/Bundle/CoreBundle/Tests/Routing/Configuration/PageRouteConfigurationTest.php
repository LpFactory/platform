...
class PageRouteConfigurationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function extractIdProvider()
    {
        return array(
            array(
                array('prefix' => 'opsite_page_view_', 'controller' => 'test'),
                'opsite_page_view_56',
                '56'
            ),
            array(
    ...
    public function testGetPageRouteName()
    {
        ...
        $page = $this
            ->getMock('OpSiteBuilder\Bundle\CoreBundle\Model\AbstractPage');
        ...
        $this->assertEquals('opsite_page_view_56', $routeConfiguration->getPageRouteName($page));
    }
    ...
    public function testGetter()
    {
        ...
        $this->assertEquals('OpSiteBuilderCoreBundle:Page:edit', $routeConfiguration->getController());
