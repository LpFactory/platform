...
namespace OpSiteBuilder\Bundle\CoreBundle\Tests\Security;

use OpSiteBuilder\Bundle\CoreBundle\Entity\Block;
use OpSiteBuilder\Bundle\CoreBundle\Entity\Page;
use OpSiteBuilder\Bundle\CoreBundle\Security\AllowAllPageVoter;
 ...
 *
 * @package OpSiteBuilder\Bundle\CoreBundle\Tests\Security
 * @author jobou
 */
class AllowAllPageVoterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSupportsClass()
    {
        ...
        $this->assertTrue($voter->supportsClass('OpSiteBuilder\Bundle\CoreBundle\Model\AbstractPage'));

        $this->assertFalse($voter->supportsClass('OpSiteBuilder\Bundle\CoreBundle\Model\AbstractBlock'));
    }
